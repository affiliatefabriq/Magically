...
export const RecommendedUserCard = ({ user }: RecommendedUserCardProps) => {
  return (
    <div className="flex flex-col items-center gap-3 p-4 rounded-2xl theme-2 transition-colors">
      ...
      <div className="flex flex-col flex-1 items-center justify-start lg:items-start min-w-0">
        <Link href={`/profile/${user.username}`} className="block">
          <p className="font-semibold text-base truncate text-center">{user.username}</p>
          {user.fullname && (
