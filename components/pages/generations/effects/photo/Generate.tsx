  ...
  return (
    <section className="max-w-3xl mx-auto">
      <div className="fixed md:hidden h-12 backdrop-blur-2xl w-full top-0 left-0 right-0 text-sm z-10">
        <Link
          href="/create/photo-effects"
          className="flex items-center justify-start h-full ml-4 link-text"
        >
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="nano-pro">
                          Nano Pro (Balanced)
                        </SelectItem>
                        <SelectItem value="gpt-1.0">
                          GPT Image 1.0 (Creative)
                        </SelectItem>
                        <SelectItem value="gpt-1.5">
                          GPT Image 1.5 (High Detail)
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
              ...
              <Button
                ...
                disabled={loading || generateNano.isPending}
              >
